...
for y =1:1:ti
    ...
    UE1_true = [10,5];UE2_true = [4,9];UE3_true = [7,3]; UE4_true = [13,14];
%     UE1_true = [12,5];UE2_true = [7,2];UE3_true = [13,13]; UE4_true = [1,0];
    ...
    %                 UE4_est = [13,14];
                    ...
                    R_3 = [R1_3; R2_3; R3_3; R4_3];
                    UE_est_123 = [UE1_est;UE2_est;UE3_est;UE4_est];
    %                 BS3_est_x = [];
    %                 BS3_est_y = [];
                    err3_arr = [];
                    index3_arr = [];
                    ...
                    for p1 = 1:1:2                            
                        if BS3_arr(1, p1 * 2) > -3 && BS3_arr(1, p1 * 2) < 23 && BS3_arr(1, p1 * 2 - 1) > -3 && BS3_arr(1, p1 * 2 - 1) <23
                            ...
                            %                                         arrr = [BS3_arr(1, p1 * 2 - 1),BS3_arr(2,  p2 * 2 - 1), BS3_arr(3,  p3 * 2 - 1),BS3_arr(4,  p4 * 2 - 1),BS3_arr(5,  p5 * 2 - 1),BS3_arr(6,  p6 * 2 - 1)]
                                                                    error3 = var([BS3_arr(1, p1 * 2 - 1),BS3_arr(2,  p2 * 2 - 1), BS3_arr(3,  p3 * 2 - 1),BS3_arr(4,  p4 * 2 - 1),BS3_arr(5,  p5 * 2 - 1),BS3_arr(6,  p6 * 2 - 1)]) +...
                                                                        var([BS3_arr(1, p1 * 2),BS3_arr(2,  p2 * 2), BS3_arr(3,  p3 * 2),BS3_arr(4,  p4 * 2),BS3_arr(5,  p5 * 2),BS3_arr(6,  p6 * 2)]);
                                                                    index3_arr = [p1;p2;p3;p4;p5;p6];
                                                                    if error3 < error3_min
                                                                        error3_min = error3;
                            %                                             err_3_arr = err3_arr;
                                                                        index_3_arr = index3_arr;
                            %                                             bs3 = [BS3_arr(1, p1 * 2 - 1),BS3_arr(2,  p2 * 2 - 1), BS3_arr(3,  p3 * 2 - 1),BS3_arr(4,  p4 * 2 - 1),BS3_arr(5,  p5 * 2 - 1),BS3_arr(6,  p6 * 2 - 1)]
                            %                                             aa = 1
        ...
        %             [error4, ind] = min(err4_arr);
                    for p1 = 1:1:2                            
                        if BS4_arr(1, p1 * 2) > -3 && BS4_arr(1, p1 * 2) < 23 && BS4_arr(1, p1 * 2 - 1) > -3 && BS4_arr(1, p1 * 2 - 1) <23
                            ...
                            %                                         arrr = [BS3_arr(1, p1 * 2 - 1),BS3_arr(2,  p2 * 2 - 1), BS3_arr(3,  p3 * 2 - 1),BS3_arr(4,  p4 * 2 - 1),BS3_arr(5,  p5 * 2 - 1),BS3_arr(6,  p6 * 2 - 1)]
                                                                    error4 = var([BS4_arr(1, p1 * 2 - 1),BS4_arr(2,  p2 * 2 - 1), BS4_arr(3,  p3 * 2 - 1),BS4_arr(4,  p4 * 2 - 1),BS4_arr(5,  p5 * 2 - 1),BS4_arr(6,  p6 * 2 - 1)]) +...
                                                                        var([BS4_arr(1, p1 * 2),BS4_arr(2,  p2 * 2), BS4_arr(3,  p3 * 2),BS4_arr(4,  p4 * 2),BS4_arr(5,  p5 * 2),BS4_arr(6,  p6 * 2)]);
                                                                    index4_arr = [p1;p2;p3;p4;p5;p6];
...
%                         UE4_best4 = UE4_est;
    ...
    error_UE3 = (abs(get_distace(UE1_best3,UE1_true))...
            ...
            +abs(get_distace(UE4_best3,UE4_true)))/4
