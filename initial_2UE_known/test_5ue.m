...
for y =1:1:ti
    ...
    UE1_true = [10,5];UE2_true = [4,9];UE3_true = [7,3]; UE4_true = [13,14]; UE5_true = [8,17];
%     UE1_true = [12,5];UE2_true = [7,2];UE3_true = [13,13]; UE4_true = [1,0];UE5_true = [7,17];

    UE1_SET = [];UE2_SET = [];UE3_SET = [];UE4_SET = [];UE5_SET = [];
    UE_num = 5;
    std = 1;
    ...
    for UE4_x = 0:20
        for UE4_y = 0:20
            UE_est = [UE4_x,UE4_y];
            d12 = get_distace(BS1_true,UE_est)-get_distace(BS2_true,UE_est);
            d12_true = get_distace(BS1_true,UE4_true)-get_distace(BS2_true,UE4_true);
            if abs(d12-d12_true)<2^(1/2) / 8
                UE4_SET = [UE4_SET;UE_est];
            end
        end
    end
    for UE5_x = 0:20
        for UE5_y = 0:20
            UE_est = [UE5_x,UE5_y];
            d12 = get_distace(BS1_true,UE_est)-get_distace(BS2_true,UE_est);
            d12_true = get_distace(BS1_true,UE5_true)-get_distace(BS2_true,UE5_true);
            if abs(d12-d12_true)<2^(1/2) / 8
                UE5_SET = [UE5_SET;UE_est];
            end
        end
    end
    error3_min = 1000000;
    ...
    for i =1:length(UE1_SET)
        ...
        for j =1:length(UE2_SET)
            for k =1:length(UE3_SET)
                for f =1:length(UE4_SET)
                    for g =1:length(UE5_SET)
                        UE1_est = UE1_SET(i,:);
                        UE2_est = UE2_SET(j,:);
                        UE3_est = UE3_SET(k,:);
                        UE4_est = UE4_SET(f,:);
...
%                         UE5_est = [8,17];
                        ...
                        R4_3 = get_distace(BS1_true,UE4_est)-...
                            (get_distace(BS1_true,UE4_true)-get_distace(BS3_true,UE4_true))+(std*randn(1)*0.3);
                        R4_4 = get_distace(BS1_true,UE4_est)-...
                            (get_distace(BS1_true,UE4_true)-get_distace(BS4_true,UE4_true))+(std*randn(1)*0.3); 
                        R5_3 = get_distace(BS1_true,UE5_est)-...
                            (get_distace(BS1_true,UE5_true)-get_distace(BS3_true,UE5_true))+(std*randn(1)*0.3);
                        R5_4 = get_distace(BS1_true,UE5_est)-...
                            (get_distace(BS1_true,UE5_true)-get_distace(BS4_true,UE5_true))+(std*randn(1)*0.3); 
                        R_3 = [R1_3; R2_3; R3_3; R4_3; R5_3];
                        UE_est_123 = [UE1_est;UE2_est;UE3_est;UE4_est;UE5_est];
        %                 BS3_est_x = [];
        %                 BS3_est_y = [];
                        err3_arr = [];
                        index3_arr = [];
        ...
        %                 end
                        for p1 = 1:1:2
                            if BS3_arr(1, p1 * 2) > -3 && BS3_arr(1, p1 * 2) < 23 && BS3_arr(1, p1 * 2 - 1) > -3 && BS3_arr(1, p1 * 2 - 1) <23
                                for p2 = 1:1:2
                                    if BS3_arr(2, p2 * 2) > -3 && BS3_arr(2, p2 * 2) < 23 && BS3_arr(2, p2 * 2 - 1) > -3 && BS3_arr(1, p2 * 2 - 1) <23
                                        for p3 = 1:1:2
                                            if BS3_arr(3, p3 * 2) > -3 && BS3_arr(3, p3 * 2) < 23 && BS3_arr(3, p3 * 2 - 1) > -3 && BS3_arr(3, p3 * 2 - 1) <23
                                                for p4 = 1:1:2
                                                    if BS3_arr(4, p4 * 2) > -3 && BS3_arr(4, p4 * 2) < 23 && BS3_arr(4, p4 * 2 - 1) > -3 && BS3_arr(4, p4 * 2 - 1) <23
                                                        for p5 = 1:1:2
                                                            if BS3_arr(5, p5 * 2) > -3 && BS3_arr(5, p5 * 2) < 23 && BS3_arr(5, p5 * 2 - 1) > -3 && BS3_arr(5, p5 * 2 - 1) <23
                                                                for p6 = 1:1:2
                                                                    if BS3_arr(6, p6 * 2) > -3 && BS3_arr(6, p6 * 2) < 23 && BS3_arr(6, p6 * 2 - 1) > -3 && BS3_arr(6, p6 * 2 - 1) <23
                                                                        for p7 = 1:1:2
                                                                            if BS3_arr(7, p7 * 2) > -3 && BS3_arr(7, p7 * 2) < 23 && BS3_arr(7, p7 * 2 - 1) > -3 && BS3_arr(7, p7 * 2 - 1) <23
                                                                                for p8 = 1:1:2
                                                                                    if BS3_arr(8, p8 * 2) > -3 && BS3_arr(8, p8 * 2) < 23 && BS3_arr(8, p8 * 2 - 1) > -3 && BS3_arr(8, p8 * 2 - 1) <23
                                                                                        for p9 = 1:1:2
                                                                                            if BS3_arr(9, p9 * 2) > -3 && BS3_arr(9, p9 * 2) < 23 && BS3_arr(9, p9 * 2 - 1) > -3 && BS3_arr(9, p9 * 2 - 1) <23
                                                                                                for p10 = 1:1:2
                                                                                                    if BS3_arr(10, p10 * 2) > -3 && BS3_arr(10, p10 * 2) < 23 && BS3_arr(10, p10 * 2 - 1) > -3 && BS3_arr(10, p10 * 2 - 1) <23
                                            %                                         arrr = [BS3_arr(1, p1 * 2 - 1),BS3_arr(2,  p2 * 2 - 1), BS3_arr(3,  p3 * 2 - 1),BS3_arr(4,  p4 * 2 - 1),BS3_arr(5,  p5 * 2 - 1),BS3_arr(6,  p6 * 2 - 1)]
                                                                                                        error3 = var([BS3_arr(1, p1 * 2 - 1),BS3_arr(2,  p2 * 2 - 1), BS3_arr(3,  p3 * 2 - 1),BS3_arr(4,  p4 * 2 - 1),BS3_arr(5,  p5 * 2 - 1),BS3_arr(6,  p6 * 2 - 1), BS3_arr(7,  p7 * 2 - 1),BS3_arr(8,  p8 * 2 - 1),BS3_arr(9,  p9 * 2 - 1),BS3_arr(10,  p10 * 2 - 1)]) +...
                                                                                                            var([BS3_arr(1, p1 * 2),BS3_arr(2,  p2 * 2), BS3_arr(3,  p3 * 2),BS3_arr(4,  p4 * 2),BS3_arr(5,  p5 * 2),BS3_arr(6,  p6 * 2), BS3_arr(7,  p7 * 2),BS3_arr(8,  p8 * 2),BS3_arr(9,  p9 * 2),BS3_arr(10,  p10 * 2)]);
                                                                                                        index3_arr = [p1;p2;p3;p4;p5;p6;p7;p8;p9;p10];
        ...
        %                 BS4_est_y = [];
            ...
            %             BS4_arr = [-100,-200,-300,-400;-500,-600,-700,-800;-900,-1000,-1100,-1200];
                        ...
                        BS4_arr = reshape(BS3_list, UE_num * (UE_num - 1) / 2, 4);
                        n4 = 0;
                        for a = 1:1:UE_num
                            for b = a+1:1:UE_num
            ...
            %             [error4, ind] = min(err4_arr);
                        for p1 = 1:1:2
                            if BS4_arr(1, p1 * 2) > -3 && BS4_arr(1, p1 * 2) < 23 && BS4_arr(1, p1 * 2 - 1) > -3 && BS4_arr(1, p1 * 2 - 1) <23
                                for p2 = 1:1:2
                                    if BS4_arr(2, p2 * 2) > -3 && BS4_arr(2, p2 * 2) < 23 && BS4_arr(2, p2 * 2 - 1) > -3 && BS4_arr(1, p2 * 2 - 1) <23
                                        for p3 = 1:1:2
                                            if BS4_arr(3, p3 * 2) > -3 && BS4_arr(3, p3 * 2) < 23 && BS4_arr(3, p3 * 2 - 1) > -3 && BS4_arr(3, p3 * 2 - 1) <23
                                                for p4 = 1:1:2
                                                    if BS4_arr(4, p4 * 2) > -3 && BS4_arr(4, p4 * 2) < 23 && BS4_arr(4, p4 * 2 - 1) > -3 && BS4_arr(4, p4 * 2 - 1) <23
                                                        for p5 = 1:1:2
                                                            if BS4_arr(5, p5 * 2) > -3 && BS4_arr(5, p5 * 2) < 23 && BS4_arr(5, p5 * 2 - 1) > -3 && BS4_arr(5, p5 * 2 - 1) <23
                                                                for p6 = 1:1:2
                                                                    if BS4_arr(6, p6 * 2) > -3 && BS4_arr(6, p6 * 2) < 23 && BS4_arr(6, p6 * 2 - 1) > -3 && BS4_arr(6, p6 * 2 - 1) <23
                                                                        for p7 = 1:1:2
                                                                            if BS4_arr(7, p7 * 2) > -3 && BS4_arr(7, p7 * 2) < 23 && BS4_arr(7, p7 * 2 - 1) > -3 && BS4_arr(7, p7 * 2 - 1) <23
                                                                                for p8 = 1:1:2
                                                                                    if BS4_arr(8, p8 * 2) > -3 && BS4_arr(8, p8 * 2) < 23 && BS4_arr(8, p8 * 2 - 1) > -3 && BS4_arr(8, p8 * 2 - 1) <23
                                                                                        for p9 = 1:1:2
                                                                                            if BS4_arr(9, p9 * 2) > -3 && BS4_arr(9, p9 * 2) < 23 && BS4_arr(9, p9 * 2 - 1) > -3 && BS4_arr(9, p9 * 2 - 1) <23
                                                                                                for p10 = 1:1:2
                                                                                                    index4_arr = [p1;p2;p3;p4;p5;p6;p7;p8;p9;p10];
                                                                                                    if BS4_arr(10, p10 * 2) > -3 && BS4_arr(10, p10 * 2) < 23 && BS4_arr(10, p10 * 2 - 1) > -3 && BS4_arr(10, p10 * 2 - 1) <23
                                            %                                         arrr = [BS3_arr(1, p1 * 2 - 1),BS3_arr(2,  p2 * 2 - 1), BS3_arr(3,  p3 * 2 - 1),BS3_arr(4,  p4 * 2 - 1),BS3_arr(5,  p5 * 2 - 1),BS3_arr(6,  p6 * 2 - 1)]
                                                                                                        error4 = var([BS4_arr(1, p1 * 2 - 1),BS4_arr(2,  p2 * 2 - 1), BS4_arr(3,  p3 * 2 - 1),BS4_arr(4,  p4 * 2 - 1),BS4_arr(5,  p5 * 2 - 1),BS4_arr(6,  p6 * 2 - 1), BS4_arr(7,  p7 * 2 - 1),BS4_arr(8,  p8 * 2 - 1),BS4_arr(9,  p9 * 2 - 1),BS4_arr(10,  p10 * 2 - 1)]) +...
                                                                                                            var([BS4_arr(1, p1 * 2),BS4_arr(2,  p2 * 2), BS4_arr(3,  p3 * 2),BS4_arr(4,  p4 * 2),BS4_arr(5,  p5 * 2),BS4_arr(6,  p6 * 2), BS4_arr(7,  p7 * 2),BS4_arr(8,  p8 * 2),BS4_arr(9,  p9 * 2),BS4_arr(10,  p10 * 2)]);
    ...
    error_UE3 = (abs(get_distace(UE1_best3,UE1_true))...
            +abs(get_distace(UE2_best3,UE2_true))...
            +abs(get_distace(UE3_best3,UE3_true))...
            +abs(get_distace(UE4_best3,UE4_true))...
            +abs(get_distace(UE5_best3,UE5_true)))/5;
    % error_UE4 = (abs(get_distace(UE1_best4,UE1_true))...
    %         +abs(get_distace(UE2_best4,UE2_true))...
    %         +abs(get_distace(UE3_best4,UE3_true))...
    %         +abs(get_distace(UE3_best4,UE3_true)))/3
    toc
